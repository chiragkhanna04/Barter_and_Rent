...
import info.loginp.Chat_yo;
import info.loginp.LoginActivity;
...
public class editprofile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mview= inflater.inflate(R.layout.fragment_editprofile, container, false);
        mauth=FirebaseAuth.getInstance();
        btn=(TextView) mview.findViewById(R.id.logoutlink);
        btn2=(TextView) mview.findViewById(R.id.chatlink);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(getActivity(), Chat_yo.class);
                startActivity(i);
            }
        });
        return mview;
